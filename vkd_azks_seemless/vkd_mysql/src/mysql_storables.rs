...
use vkd::history_tree_node::{HistoryTreeNode, NodeKey};
use vkd::node_state::{HistoryChildState, HistoryNodeState, NodeStateKey};
    ...
    fn get_specific_params<St: Storable>(key: &St::Key) -> Option<mysql_async::Params> {
        match St::data_type() {
            ...
            StorageType::HistoryNodeState => {
                ...
                if let Ok(back) = vkd::node_state::HistoryNodeState::key_from_full_binary(&bin) {
                    Some(params! {
