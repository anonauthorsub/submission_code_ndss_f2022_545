...
//! # Overview
//!
//! This crate contains a "lean" client to verify VKD proofs which doesn't depend on any
...
//! without depending on the full VKD library.
//!
...
//! use the base VKD library crate.
//!
//! ## Features
//!
...
//!
//! For WASM deployment of the VKD client, you'll want to read the [wasm_bindgen](https://rustwasm.github.io/wasm-bindgen/reference/deployment.html)
//! documentation which has reference material dependent on your environment.
//!
//! # Client Types
//!
//! A small note about the types in this library. They are specifically independent of the main VKD crate because
...
//! of the VKD crate which wouldn't be a dependency anyways. This is why the types are independent and specified separately
//! from the core VKD types.
//!
#![warn(missing_docs)]
...
pub fn lookup_verify(
    ...
    let label: VkdLabel = label_slice.to_vec();
