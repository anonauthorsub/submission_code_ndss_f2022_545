...
//! to verify any of the following VKD proofs
//!
//! 1. Lookup
//!
...
/// The label of a particular entry in the VKD
pub type VkdLabel = Vec<u8>;
/// The value of a particular entry in the VKD
pub type VkdValue = Vec<u8>;
...
/// Represents the label of a VKD node
...
/// Represents a node (label + hash) in the VKD
#[cfg_attr(feature = "wasm", derive(serde::Serialize, serde::Deserialize))]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct Node {
...
pub struct LookupProof {
    ...
    /// Proof for commitment value derived from raw VkdLabel and VkdValue
