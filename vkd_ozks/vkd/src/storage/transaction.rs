...
mod tests {
    use super::*;
    use crate::ordered_append_only_zks::*;
    ...
    async fn test_commit_order() -> Result<(), StorageError> {
        ...
        let value2 = DbRecord::ValueState(ValueState {
            ...
            label: NodeLabel::new(byte_arr_from_u64(1), 1),
            version: 2,
            plaintext_val: VkdValue::from_utf8_str("abc1234"),
        });

        let records = vec![ozks, node1, node2, value1, value2];
        let mut rng = OsRng;
