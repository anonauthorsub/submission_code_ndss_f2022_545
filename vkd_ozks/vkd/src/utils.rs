...
// Used by the server to produce a commitment proof for an VkdLabel, version, and VkdValue
...
// Used by the server to produce a commitment for an VkdLabel, version, and VkdValue
//
...
pub(crate) fn bind_commitment<H: Hasher>(value: &VkdValue, proof: &[u8]) -> H::Digest {
